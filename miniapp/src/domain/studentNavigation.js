export const STUDENT_ENTRIES = Object.freeze([
  ...
  { id: 'recommend', label: '智能推荐', shortLabel: '推荐', description: '结合档案与今日供应生成建议', eyebrow: '智能吃饭', route: '/pages/dishes/dishes', navigationType: 'switchTab', iconName: 'bulb', group: 'core', tone: 'discover', discoveryMode: 'recommend' },
  ...
  { id: 'regions', label: '区域推荐', shortLabel: '风味', description: '从六种风味里发现下一餐', eyebrow: '更多探索', route: '/pages/regions/regions', navigationType: 'navigateTo', iconName: 'compass', group: 'explore', tone: 'discover' },
  ...
  { id: 'orders', label: '今日点餐', shortLabel: '点餐', description: '浏览菜单、购物车和取餐码', eyebrow: '个人记录', route: '/pages/orders/orders', navigationType: 'navigateTo', iconName: 'store', group: 'records', tone: 'records', badge: '联调中' },
