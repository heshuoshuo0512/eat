<template>
  <sc-page-shell tone="orange">
    <view class="login-hero"><view class="logo-orb">食</view><text class="hero-kicker">SMART CANTEEN</text><text class="hero-title">把校园每一餐，做成你的专属推荐。</text><text class="hero-subtitle">今日菜单、健康餐单、拍照识餐、AI 顾问，一个小程序完成。</text></view>
...
<style scoped>
.login-hero { overflow:hidden; margin-bottom:24rpx; padding:44rpx 34rpx; border-radius:44rpx; color:#fff; background:linear-gradient(140deg,#b7efd2 0%,#6cddb0 46%,#1f9f72 100%); }.logo-orb { display:flex; align-items:center; justify-content:center; width:92rpx; height:92rpx; margin-bottom:28rpx; border-radius:30rpx; color:#58cfa0; background:#fff; font-size:46rpx; font-weight:950; }.login-card { margin-bottom:22rpx; }.demo-btn { margin-top:18rpx; }.promise-grid { margin-bottom:40rpx; }
</style>
