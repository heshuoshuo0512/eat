...
GRANT SELECT ON outbox_events, rag_documents, retrieval_index_runs, dishes, stalls, canteens, menus, menu_items, tenants,
  catalog_introduction_batches, catalog_entity_introductions TO smart_canteen_worker;
