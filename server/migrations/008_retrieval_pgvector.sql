-- Runtime PostgreSQL migration. Keep in sync with
-- migrations/postgres/002_retrieval_pgvector.sql.
...
INSERT INTO schema_migrations(version) VALUES ('008_retrieval_pgvector')
