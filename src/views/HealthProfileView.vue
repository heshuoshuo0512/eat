...
.profile-actions { display:flex; gap:12px; justify-content:flex-end; }.profile-actions>* { min-width:180px; min-height:46px; justify-content:center; text-align:center; line-height:1.35; white-space:normal; overflow-wrap:anywhere; }
