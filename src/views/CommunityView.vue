...
.rating-picker { display: flex; align-items: center; gap: 14px; flex-wrap: wrap; }.star-button { width: 36px; height: 36px; padding: 0; border: 0; background: transparent; color: #c9cec7; font-size: 24px; }.star-button.active { color: #e0a11a; transform: scale(1.08); }
...
.post-feed { columns: 2; column-gap: 16px; }.post-item { break-inside: avoid; display: grid; gap: 14px; margin-bottom: 16px; padding: 18px; border: 1px solid rgba(31, 122, 77, .14); border-radius: 8px; background: #fff; transition: transform .22s ease, box-shadow .22s ease; }.post-item:hover { transform: translateY(-3px); box-shadow: 0 14px 28px rgba(21, 95, 59, .09); }
...
@media (prefers-reduced-motion: reduce) { .post-composer { animation: none; }.post-item { transition: none; } }
</style>
